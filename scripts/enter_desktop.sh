...
# Launch desktop
chroot "$DEBIAN_ROOT" /usr/bin/env -i     HOME=/root     TERM="$TERM"     PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"     ADSP_LIBRARY_PATH="/vendor/lib/rfsa/adsp:/system/vendor/lib/rfsa/adsp:/vendor/lib64"     LD_LIBRARY_PATH="/usr/local/lib:/vendor/lib64:/system/vendor/lib64"     GGML_HEXAGON_NDEV=2     /bin/bash --login -c "startx"
